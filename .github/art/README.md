...
| move, add or fix a **door / way between rooms** | [`../../docs/DOOR_STANDARD.md`](../../docs/DOOR_STANDARD.md) — doors are as much code as art, and it is the disagreement between the two that breaks them ([`.rules.md`](../../docs/DOOR_STANDARD.rules.md) is the stripped card a Clubhouse run reads; GENERATED by `rules_card.py`) | `node ../../.github/scripts/check_room_exits.mjs`, then `room.py verify` |
