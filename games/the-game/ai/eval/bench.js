...
exports.run = function (weights, seed, opts) {
    ...
    var KNOWN_OPTS = ['allowRaise', 'arena', 'beam', 'brain', 'checkTiming',
                      ...
                      'goal', 'alsoTake', 'buildToward', 'dangerWeights'];
    for (var opt in opts) {
    ...
    var cpu, detach = null;
    {
        cpu = new PuyoCpu(stack, {
            ...
            goal: opts.goal, alsoTake: opts.alsoTake,
            buildToward: opts.buildToward, dangerWeights: opts.dangerWeights
        });
    }
    ...
    return { frames: f, sent: sent, score: stack.score || 0, died: !!stack.gameOver,
             ...
             modeCounts: cpu.modeCounts || { BUILD: 0, ATTACK: 0, FORCED: 0 },
